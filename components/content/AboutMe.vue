<template>
    <SPAPanel>
        ...
        <p>
            Born in the <Highlight>early 90s</Highlight>, I got my first computer when I was 6. When I played the first
            video games on it, I was wondering
            <Highlight>"Somebody must have told the computer what it should do — how does that even work?"</Highlight>.
        </p>
        <p>
        ...
        <p>
            But I never forgot about the old times when I tried to figure out how computers work. So in
            <Highlight>2016</Highlight> I started studying <Highlight>computer science</Highlight> to acquire that
            knowledge once and for all.
        </p>
        <p>
            In <Highlight>2020</Highlight> Covid hit hard. I financed my studies freelancing in lighting design during
            that time and as the live industry shut down, my profession was useless all of a sudden.
        </p>
        <p>
